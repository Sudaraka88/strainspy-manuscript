...
ZB_fit <- glmZiBFit(sy,  design, nthreads = parallel::detectCores())
...
plot_manhattan(ZB_fit, taxonomy = taxonomy, aggregate_by_taxa = T)
plot_manhattan(ZB_fit, taxonomy = taxonomy, aggregate_by_taxa = F)
plot_volcano(ZB_fit)

OB_fit <- glmFit(sy,  design, nthreads = 10)
...
plot_ani_dist(sy, phenotype = 'disease', contigs = top_hits(ZB_fit)$Contig_name[1:10], 
              drop_zeros = F, show_points = T, plot_type = 'violin')
...
plot_ani_dist(sy, 'Case_status', contigs = top_hits(logit_fit)$Contig_name[1:5], plot_type = "box")
plot_ani_dist(sy, 'Case_status', contigs = top_hits(logit_fit)$Contig_name[1:5], drop_zeros = T, plot_type = "box")
