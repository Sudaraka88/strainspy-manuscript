...
## ANI distributions of the top strain of each beta detected species 
...
# E coli
plot_histogram(sy, phenotype = 'disease', contig = "NZ_CAACXL010000001.1 Escherichia coli strain 13591 isolate 13591, whole genome shotgun sequence", drop_zeros = T, show_quantiles = F, fit_spline = T, bins = 40, fit_control = 100)

# F prausnitzii
plot_histogram(sy, phenotype = 'disease', contig = "CATXFM010000001.1 MAG TPA_asm: Faecalibacterium prausnitzii isolate SRR17798033_bin.2_MetaWRAP_v1.3_MAG genome assembly, contig: ERZ18698391.52, whole genome shotgun sequence", drop_zeros = T, show_quantiles = F, fit_spline = T, bins = 40, fit_control = 100)
