...
plot_ani_dist(d_q95, phenotype = 'spiked', contigs = top_hits(fit_zib_95, alpha = 0.1)$Contig_name, drop_zeros = F, show_points = T, plot_type = 'violin')
plot_ani_dist(d_q95, phenotype = 'spiked', contigs = top_hits(fit_zib_95, alpha = 0.1)$Contig_name, drop_zeros = T, show_points = T, plot_type = 'violin')
```
...
plot_ani_dist(d_q99, phenotype = 'spiked', contigs = top_hits(fit_zib_99, alpha = 1e-10)$Contig_name)
plot_ani_dist(d_q99, phenotype = 'spiked', contigs = top_hits(fit_zib_99, alpha = 1e-10)$Contig_name, drop_zeros = T)
