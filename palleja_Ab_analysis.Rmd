...
plot_ani_dist(se_p, 'days', pool_contigs(fit_zib_p), show_points = T, plot_type = "box")
...
generate_species_plot = function(fit_ab){
  ...
  plt_dat = plot_ani_dist(se_p95_abund,phenotype = 'days',contigs = pool_contigs(fit_ab) ,show_points = TRUE,plot_type = 'box', plot = F)
  plt_dat = plt_dat %>% 
